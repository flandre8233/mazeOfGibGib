...
public class playerMainScript : MonoBehaviour
{
    ...
    public void checkLife()
    {
        ...
        if (playerDataBase.Static.SP > 0) {
            ...
            {
                Instantiate(particleManager.Static.character_run_inside01_heal, new Vector3(gameObject.transform.position.x, gameObject.transform.position.y, -0.5f), new Quaternion(-180, 0, 0, 0) ); //粒子
                hpHasChanged = true;
            ...
            {
                Instantiate(particleManager.Static.character_run_inside01_hurt, new Vector3(gameObject.transform.position.x, gameObject.transform.position.y, -0.5f), new Quaternion(-180,0,0,0) );  //粒子
                hpHasChanged = true;
        ...
        if (!hpHasChanged)
        {
            Instantiate(particleManager.Static.character_run_inside01_normal,new Vector3(gameObject.transform.position.x, gameObject.transform.position.y,-0.5f), new Quaternion(-180, 0, 0, 0) ); //粒子
        }
